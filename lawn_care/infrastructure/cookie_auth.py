...
from lawn_care.infrastructure.num_convert import try_int

auth_cookie_name = 'local_lawncare_user'
...
def __add_cookie_calback(_, response: Response, name: str, value: str):
